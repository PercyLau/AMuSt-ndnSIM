...
PUBLIC_WITH_TESTS_ELSE_PRIVATE: // pipelines
  ...
  */ 
  void
  onContentStoreMiss(const Face& inFace, shared_ptr<pit::Entry> pitEntry, const Interest& child_interest, const Interest& parent_interest);
...
//OON
  void
  onProcessingData(const Face& inFace, const Interest& parent_interest, bool* tag, const Interest& child_interest, const Data& data);
...
private:
  ...
  public:
   shared_ptr<NullFace> m_opFace; //OON
  Cs             m_op; //OON
  ns3::Ptr<ns3::ndn::ContentStore> m_opFromNdnSim;//OON
...
inline void
Forwarder::setOpFromNdnSim(ns3::Ptr<ns3::ndn::ContentStore> op)
{
  m_opFromNdnSim = op;
}
